...
namespace WinFormUI
{
    public partial class Dashboard : Form
    {
        ...
        {
            errorMessage.Text = $"You hade an overdraft protection transfer of {string.Format("{0:C2}", e)}";
        ...
        {
            customer.CustomerName = "Deric Lu";
            customer.CheckingAccount = new Account();
            customer.SavingsAccount = new Account();

            customer.CheckingAccount.AccountName = "Deric's Checking Account";
            customer.SavingsAccount.AccountName = "Deric's Savings Account";
